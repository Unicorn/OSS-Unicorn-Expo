...
const Styled = createRestyleComponent<
  VariantProps<ChuzTheme, typeof themeKey> & React.ComponentProps<typeof View>,
  ChuzTheme
>([createVariant({ themeKey, defaults: sliderVariants.defaults })], View);
    ...
    <View ref={sliderRef} {...panResponder.panHandlers}>
      ...
      <Styled>
        <View
          style={[
            styles.fill,
            { width: `${value}%`, backgroundColor: `hsl(171, ${50 + 0.3 * value}%, ${30 + 0.1 * value}%)` },
          ]}
        />
      </Styled>
    </View>
