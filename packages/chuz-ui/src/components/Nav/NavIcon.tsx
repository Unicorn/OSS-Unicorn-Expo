...
const Styled = createRestyleComponent<
  VariantProps<ChuzTheme, typeof themeKey> & ComponentProps<typeof MaterialIcons>,
  ChuzTheme
>([createVariant({ themeKey, defaults: navIconVariants.defaults })], MaterialIcons);

interface Props extends IconProps<keyof typeof MaterialIcons.glyphMap> {
  variant?: "defaults" | "hovered" | "active";
}

export const NavIcon: FC<Props> = (props) => {
  return <Styled {...props} />;
};
